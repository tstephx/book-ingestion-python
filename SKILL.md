...
For this book ingestion project:
...
pytest tests/processors/test_chapter_detector.py -v
...
# 3. Process a test book (if adding processing features)
python src/cli.py process /path/to/test.pdf --debug
```
